...
const contactTopColumns = [
	...
	},
	{
		...
		body: 'Join our Discord, volunteer, or enroll in our projects. There are many ways to contribute and benefit.'
	},
	{
		title: 'Who Can Contact?',
...
const Contact: React.FC = () => (
	<Box px={{ xs: 2, md: 6 }} py={6}>
		...
		{/* Discord Section - Two Columns, blue box styled like Projects */}
		<Box display="grid" gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }} gap={4} mb={6}>
				<Box textAlign="center">
					...
					<Typography color="text.secondary" fontFamily="Inter, Arial, sans-serif" mb={2} align="center">Connect with fellow students, get help from mentors, and stay up to date with our latest projects and events.</Typography>
				</Box>
	<Box bgcolor="#303947" color="#fff" borderRadius={2} p={4} border="3px solid #4083cc">
		...
		{/* Volunteer Form Section - Two Columns, orange box styled like Projects */}
		<Box display="grid" gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }} gap={4} mb={6}>
